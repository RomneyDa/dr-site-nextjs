    ...
    >
      ...
      <div className="text-4xl mx-auto text-center rounded-lg flex flex-col items-center justify-center">
        ...
        >
          ...
          <p
            className="text-xl transition-all bg-background/70 p-2"
            style={{
          ...
          >
            ...
            <a
              ...
              target="_blank"
              className="text-blue-500 cursor-pointer hover:scale-105 hover:text-blue-400 transition-all"
            >
              Continue.dev
            </a>
          </p>
          <p
            className="text-sm transition-all bg-background/70 px-8 max-w-[700px]"
            style={{
              opacity: showSkill2 ? 1 : 0,
              transition: "opacity 1s",
            }}
          >
            Building the leading open-source AI Coding Assistant for VS Code and
            Jetbrains
          </p>
          <p
            className="text-sm transition-all bg-background/70 px-2"
            style={{
      ...
      {/* </div> */}
      <Link
        className="transition-all z-40 absolute bottom-[10%] right-1/2 translate-x-1/2 bg-background p-2 rounded-full hover:bg-muted cursor-pointer"
        href="#portfolio"
        style={{
          opacity: showSubtitle ? 1 : 0,
        }}
